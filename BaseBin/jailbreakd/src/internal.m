...
int jailbreakd_handle_internal(const char *command, int argc, char* argv[])
{
	...
	//}
		...
		return mount_unsandboxed("bindfs", (void *)JBROOT_PATH("/System/Library/Fonts"), MNT_RDONLY, "/System/Library/Fonts");
	}
	else if (!strcmp(command, "cores_mount")) {
		printf("Applying cores mount...\n");
		return mount_unsandboxed("bindfs", "/cores", MNT_RDONLY, (void *)JBROOT_PATH("/cores"));
	}
